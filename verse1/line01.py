"""
Line01 — "Boom boom when i come in the game it goes boom boom"
Effect: BOOM on left, BOOM on right with particle explosion, then rest of the lyrics in big text
"""
import math
import sys
import pyfiglet
